if not mods.pystellarexpedition then
    data:extend{
    {
        ...
        icon = "__planetaris-arig__/graphics/achievement/research-with-compression.png",
        icon_size = 128
    }
}
end
...
data:extend{
    ...
    surface = "arig",
    icon = "__planetaris-arig__/graphics/achievement/visit-arig.png",
    icon_size = 128,
    },
    {
    ...
    icon = "__planetaris-arig__/graphics/achievement/everything-is-better-with-support.png",
    icon_size = 128
  }
}