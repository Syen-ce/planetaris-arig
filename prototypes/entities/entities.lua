...
data:extend({
    ...
    minable = {mining_time = 0.1, result = "sifter"},
    fast_replaceable_group = nil,
    max_health = 350,
    corpse = "sifter-remnants",
    dying_explosion = "sifter-explosion",
...
},
{
  ...
  flags = {"placeable-neutral", "placeable-player", "player-creation"},
  minable = {mining_time = 0.5, result = "press"},
  fast_replaceable_group = nil,
  max_health = 200,
  corpse = "press-remnants",
...
},
{
  ...
  max_health = 400,
  corpse = "assembling-machine-4-remnants",
  dying_explosion = "assembling-machine-4-explosion",
