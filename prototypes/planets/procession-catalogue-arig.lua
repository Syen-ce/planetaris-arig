...
return
{
  -- CLOUDS
  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-cloudscape.png",
      width = 960,
      height = 960,
      priority = "no-atlas",
...

  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-cloudscape-layered-0.png",
      width = 2000,
      height = 1500,
      priority = "no-atlas",
      flags = { "group=effect-texture", "linear-minification", "linear-magnification" },
...

  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-cloudscape-layered-1.png",
      width = 1600,
      height = 1200,
      priority = "no-atlas",
      flags = { "group=effect-texture", "linear-minification", "linear-magnification" },
...

  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-cloudscape-layered-2.png",
      width = 1400,
      height = 1050,
      priority = "no-atlas",
      flags = { "group=effect-texture", "linear-minification", "linear-magnification" },
...

  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-cloudscape-layered-3.png",
      width = 1200,
      height = 900,
      priority = "no-atlas",
      flags = { "group=effect-texture", "linear-minification", "linear-magnification" },
  ...
  },
  {
    ...
    type = "sprite",
    sprite = {
      filename = "__planetaris-arig__/graphics/procession/arig-sky-tint.png",
      width = 16,
      height = 16,
      priority = "no-atlas",
      flags = { "group=effect-texture", "linear-minification", "linear-magnification" },
